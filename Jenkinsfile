pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://3.90.20.126:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/klu2300031331/s111_fullstack_app1.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://3.90.20.126:9090/springapp1"
            echo "✅ Frontend deployed: http://3.90.20.126.226:9090/frontapp1"
        }
        failure {
